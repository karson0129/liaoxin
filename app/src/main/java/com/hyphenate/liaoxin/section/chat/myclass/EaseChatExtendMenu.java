...
public class EaseChatExtendMenu extends FrameLayout implements PagingScrollHelper.onPageChangeListener, IChatExtendMenu, OnItemClickListener {
    ...
    private List<com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel> itemModels = new ArrayList<com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel>();
    private Map<Integer, com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel> itemMap = new HashMap();
    ...
    public void setMenuOrder(int itemId, int order) {
        if(itemMap.containsKey(itemId)) {
            com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel model = itemMap.get(itemId);
            if(model != null) {
                model.order = order;
    ...
    public void registerMenuItem(String name, int drawableRes, int itemId, EaseChatExtendMenuItemClickListener listener) {
        if(!itemMap.containsKey(itemId)) {
            com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel item = new com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel();
            item.name = name;
    ...
    private void sortByOrder(List<com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel> itemModels) {
        Collections.sort(itemModels, new Comparator<com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel>() {
            @Override
            public int compare(com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel o1, com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel o2) {
    ...
    public void onItemClick(View view, int position) {
        com.hyphenate.easeui.modules.chat.EaseChatExtendMenu.ChatMenuItemModel itemModel = itemModels.get(position);
