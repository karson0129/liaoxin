...
/**
 * import com.hyphenate.easeui.modules.chat.EaseChatFragment; 参考这个类
 * */
public class EaseChatFragment extends EaseBaseFragment implements OnChatLayoutListener, OnMenuChangeListener, OnAddMsgAttrsBeforeSendEvent {
    ...
    private static final String TAG = com.hyphenate.easeui.modules.chat.EaseChatFragment.class.getSimpleName();
    ...
    private int getLayoutId() {
        return R.layout.ease_fragment_my_chat_list;
    }
