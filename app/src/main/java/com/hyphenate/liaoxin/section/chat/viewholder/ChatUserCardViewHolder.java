package com.hyphenate.liaoxin.section.chat.viewholder;
...
import com.hyphenate.liaoxin.section.chat.views.chatRowUserCard;
...
public class ChatUserCardViewHolder extends EaseChatRowViewHolder {
    ...
    public static ChatUserCardViewHolder create(ViewGroup parent, boolean isSender, MessageListItemClickListener itemClickListener) {
