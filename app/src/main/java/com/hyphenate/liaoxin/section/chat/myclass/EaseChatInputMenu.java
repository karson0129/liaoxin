...
/**
 * 自己的类
 * import com.hyphenate.easeui.modules.chat.EaseChatInputMenu; 参考
 */
public class EaseChatInputMenu extends LinearLayout implements IChatInputMenu, EaseChatPrimaryMenuListener, EaseEmojiconMenuListener, EaseChatExtendMenuItemClickListener {
    private static final String TAG = com.hyphenate.easeui.modules.chat.EaseChatInputMenu.class.getSimpleName();
