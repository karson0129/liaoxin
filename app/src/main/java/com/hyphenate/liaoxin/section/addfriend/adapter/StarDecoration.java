...
import com.hyphenate.liaoxin.section.addfriend.AddressBookActivity;
...
//        groupHeaderHeight = dp2px(context,100);
    ...
    public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof AddressBookAdapter){
            AddressBookAdapter adapter = (AddressBookAdapter) parent.getAdapter();
            //当前屏幕的item个数
